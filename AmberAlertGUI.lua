-- ULTIMATE AMBER ALERT CHEAT GUI
...
local TrollTabBtn = createTabButton("FUN", "Fun", 0.75)
...
local function showMainTab()
    ...
    infoLabel.Text = "TELEPORT: Drücke STRG + Linksklick auf Boden"
    ...
    -- GODMODE
    local godBtn = createButton("🛡️ GODMODE: " .. (cheats.godmode and "ON" or "OFF"), yPos, Color3.fromRGB(0, 150, 0), function()
        toggleGodmode()
    ...
    -- INVISIBLE
    local invisBtn = createButton("👻 INVISIBLE: " .. (cheats.invisible and "ON" or "OFF"), yPos, Color3.fromRGB(138, 43, 226), function()
        toggleInvisible()
        invisBtn.Text = "👻 INVISIBLE: " .. (cheats.invisible and "ON" or "OFF")
    end)
    yPos = yPos + 45
    
    -- NOCLIP
    local noclipBtn = createButton("🚪 NOCLIP: " .. (cheats.noclip and "ON" or "OFF"), yPos, Color3.fromRGB(30, 144, 255), function()
        toggleNoclip()
    ...
    -- ESP
    local espBtn = createButton("👁️ ESP: " .. (cheats.esp and "ON" or "OFF"), yPos, Color3.fromRGB(100, 255, 255), function()
        toggleESP()
    ...
    -- AIMBOT
    local aimBtn = createButton("🎯 AIMBOT: " .. (cheats.aimbot and "ON" or "OFF"), yPos, Color3.fromRGB(255, 50, 50), function()
        toggleAimbot()
        aimBtn.Text = "🎯 AIMBOT: " .. (cheats.aimbot and "ON" or "OFF")
    end)
    yPos = yPos + 45
    
    -- INFINITY JUMPS
    local jumpBtn = createButton("∞ INFINITY JUMPS: " .. (cheats.infjumps and "ON" or "OFF"), yPos, Color3.fromRGB(50, 205, 50), function()
        toggleInfJumps()
        jumpBtn.Text = "∞ INF JUMPS: " .. (cheats.infjumps and "ON" or "OFF")
    end)
    yPos = yPos + 45
    
    -- MONEY MULTIPLY
    local moneyBtn = createButton("💰 MONEY x10: " .. (cheats.moneymultiply and "ON" or "OFF"), yPos, Color3.fromRGB(255, 215, 0), function()
        toggleMoneyMultiply()
        moneyBtn.Text = "💰 MONEY x10: " .. (cheats.moneymultiply and "ON" or "OFF")
    end)
    yPos = yPos + 45
    
    -- KILL AURA
    local auraBtn = createButton("⚔️ KILL AURA: " .. (cheats.killaura and "ON" or "OFF"), yPos, Color3.fromRGB(255, 69, 0), function()
        toggleKillAura()
        auraBtn.Text = "⚔️ KILL AURA: " .. (cheats.killaura and "ON" or "OFF")
    end)
    yPos = yPos + 45
...
local function showPlayersTab()
    ...
    for _, targetPlayer in pairs(Players:GetPlayers()) do
        if targetPlayer ~= player then
            ...
            trollBtn.Size = UDim2.new(btnWidth, -5, 0, 30)
            trollBtn.Position = UDim2.new(0.35, 0, 0, btnY)
            ...
            trollBtn.MouseButton1Click:Connect(function()
                ...
                trollBtn.Text = "✅ TROLLED"
            end)
            
            -- Teleport Button
            local tpBtn = Instance.new("TextButton")
            tpBtn.Size = UDim2.new(btnWidth, -5, 0, 30)
            tpBtn.Position = UDim2.new(0.68, 0, 0, btnY)
...
local function switchTab(tabName)
    ...
    TrollTabBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 60)
    ...
    TrollTabBtn.TextColor3 = Color3.fromRGB(200, 200, 255)
    ...
    elseif tabName == "Fun" then
        TrollTabBtn.BackgroundColor3 = Color3.fromRGB(255, 50, 50)
        TrollTabBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
        showFunTab()
    end
end
...
TrollTabBtn.MouseButton1Click:Connect(function() switchTab("Fun") end)
...
print("✅ GODMODE: Unsterblich in jedem Spiel")
print("✅ INVISIBLE: Vollständig unsichtbar")
print("✅ NOCLIP: Durch alle Wände gehen")
print("✅ ESP: Spieler & Entities sehen + Leben")
print("✅ AIMBOT: Auto-Aim auf Spieler & Entities")
print("✅ INFINITY JUMPS: Unendlich springen")
print("✅ MONEY MULTIPLY: Geld x10 in allen Spielen")
print("✅ KILL AURA: Entities attacken dich")
print("✅ TELEPORT: STRG + Linksklick auf Boden")
