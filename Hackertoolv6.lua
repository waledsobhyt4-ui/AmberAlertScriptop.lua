-- ==================================================
-- THE HACKER V6 - ULTIMATE EDITION (MOBILE/PC)
-- YouTube: @Hacker666-00
-- Automatische Mobile/PC Erkennung
-- GUI Toggle: RightControl / Insert
-- ==================================================
...
local mobileToggleSize = 50
local mobileTogglePos = UDim2.new(0, 20, 0.8, 0)
...
-- ==================================================
-- MOBILE TOGGLE BUTTON (nur für Mobile)
-- ==================================================
local MobileToggle = Instance.new("TextButton")
MobileToggle.Name = "MobileToggle"
MobileToggle.Size = UDim2.new(0, mobileToggleSize, 0, mobileToggleSize)
MobileToggle.Position = mobileTogglePos
...
MobileCorner.CornerRadius = UDim.new(0, mobileToggleSize/2)
...
-- Device Info (Mobile/PC Anzeige)
local DeviceLabel = Instance.new("TextLabel")
DeviceLabel.Name = "DeviceLabel"
DeviceLabel.Size = UDim2.new(0, 60, 0, 25)
DeviceLabel.Position = UDim2.new(0.6, 0, 0.5, -12.5)
DeviceLabel.BackgroundColor3 = isMobile and Color3.fromRGB(0, 150, 255) or Color3.fromRGB(0, 200, 0)
...
local function toggleGUI()
    ...
    -- Mobile Toggle Button Farbe ändern
    if isMobile then
...
print("🎮 Toggle GUI: RightControl / Insert" .. (isMobile and " oder Mobile Button" or ""))
print("👤 YouTube: @Hacker666-00")

-- Zeige MAIN Tab beim Start
switchTab("MAIN")
