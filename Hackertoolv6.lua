-- ==================================================
-- THE HACKER V6 - ULTIMATE EDITION (START BUTTON)
-- YouTube: @Hacker666-00
-- EIN Start-Button - Automatische Geräteerkennung!
-- ==================================================
...
print("👤 YouTube: @Hacker666-00") ist es jetzt richtig 
