...
DeviceLabel.Size = UDim2.new(0, isMobile and 70 or 50, 0, 25)
DeviceLabel.Position = UDim2.new(0.7, 0, 0.5, -12.5)
...
DeviceLabel.Text = isMobile and "📱 MOBIL" or "💻 PC"
...
TitleSettingsBtn.Size = UDim2.new(0, 32, 0, 32)
TitleSettingsBtn.Position = UDim2.new(1, -74, 0.5, -16)
TitleSettingsBtn.BackgroundColor3 = Color3.fromRGB(80, 80, 90)
TitleSettingsBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
TitleSettingsBtn.Font = Enum.Font.GothamBold
TitleSettingsBtn.TextSize = 18
